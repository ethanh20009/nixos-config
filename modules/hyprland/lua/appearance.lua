...
hl.animation({ leaf = "specialWorkspaceIn", enabled = true, speed = 2, bezier = "default", style = "slidefadevert -100%" })
hl.animation({ leaf = "specialWorkspaceOut", enabled = true, speed = 2, bezier = "default", style = "slidefadevert -100%" })
